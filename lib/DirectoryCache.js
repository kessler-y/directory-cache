...
var logger = require('debug')('directory-cache');
...
DirectoryCache.prototype.init = function(initCallback) {
	...
	debug('creating directory cache for [%s]', directory);
